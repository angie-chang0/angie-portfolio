...
export const New = () => {
  return (
    <section
      id="about"
      className="relative min-h-screen flex items-center justify-center py-20 bg-[rgb(216,218,215)]"
    >
      ...
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center md:items-start relative">
          <div className="relative w-60 h-60 md:w-100 md:h-100 mb-12 md:mb-0 md:mr-10 flex flex-col items-center">
            ...
            <div className="text-black text-md space-y-20 text-center md:text-left">
              <p>
                Additionally, in my freetime I love to draw, animate, and develop games in game jams. 
                I'm an avid cinephile and love to watch movies; the good, the bad, and the terrible! 
                Dont be a stranger, hit me up with movie reccomendations :D
              </p>
            </div>
          </div>
